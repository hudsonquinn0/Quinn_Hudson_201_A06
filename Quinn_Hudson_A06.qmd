...
max_median_temp = med_temps_data_frame$median_temp[which.max(median_temps_data_frame$median_temp)]

max_year = med_temps_data_frame$year[which.max(median_temps_data_frame$median_temp)]

min_median_temp = med_temps_data_frame$median_temp[which.min(median_temps_data_frame$median_temp)]

min_year = med_temps_data_frame$year[which.min(median_temps_data_frame$median_temp)]
